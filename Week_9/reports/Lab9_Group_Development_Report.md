...
- `ARCHITECTURE.md` (Week_9/): 4-layer system, agent lifecycle, 9 tools, observability stack.
- `EVALUATION.md` (Week_9/): 10-scenario methodology, S2 root-cause, CI integration, traceability table.
...
| Phase 2 GitHub | https://github.com/mosomo82/CS5542_SmartSC_Optimization_System |
| Lab 6 Live App | https://cs5542logisticsai.streamlit.app/ |
| Lab 6–9 Main Repo | https://github.com/mosomo82/COMP_SCI_5542 |
| Lab 7 ReMindRAG Repo | https://github.com/mosomo82/ReMindRAG_Week7 |
| Phase 2 ARCHITECTURE.md | github.com/.../CS5542_SmartSC.../blob/main/ARCHITECTURE.md |
| Phase 2 EVALUATION.md | github.com/.../CS5542_SmartSC.../blob/main/EVALUATION.md |
| Lab 8 ARCHITECTURE.md | github.com/.../COMP_SCI_5542/blob/main/Week_8/ARCHITECTURE.md |
| Lab 7 BENCHMARKING.md | github.com/mosomo82/ReMindRAG_Week7/blob/main/BENCHMARKING.md |
