...
### 5.5 Local Hardware Evaluation (RTX 3060)

A real-hardware evaluation was conducted locally using the PEFT-adapted phi-2 model to validate results on physical GPU infrastructure.

**Setup:** RTX 3060 12GB, phi-2 + PEFT adapter, 4-bit NF4 quantization (matching training config), `--mode real`, 15 queries.

| Metric | Result |
| :--- | :---: |
| **Overall Accuracy** | 40.0% |
| **Invariance** (Q11 vs Q12) | ✅ PASS |
| **Monotonicity** (Q13 vs Q14) | ❌ FAIL |
| **Symmetry** (Q15) | ✅ PASS |
